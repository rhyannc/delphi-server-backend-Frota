...
begin
  ...
  try
    ...
    PORTA := IniFile.ReadInteger('API', 'Port', 3050);  // Valor padrão 0 caso não exista
...
begin
    ...
    Controllers.Drivers.RegistrarRotas;
    Controllers.Material.RegistrarRotas;
    Controllers.Points.RegistrarRotas;
    Controllers.Vehicles.RegistrarRotas;
    ...
    if DB <> '' then
     begin
      pnl_status.Color := RGB(77, 126, 195);
